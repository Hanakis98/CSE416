...
//             comments: [],
//             commentToAdd:"",
//             showAddCourseWarningModal: false
...
//     addCourseToPlan = (name, semester, valid, complete) => {
...
//                         {/* <Button onClick = {(e) => this.addCourseToPlan()} color="success" style={{width:"120px",margin:"5px"}} >Add Course</Button> */}
